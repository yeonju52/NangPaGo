export const HEADER_STYLES = {
  ...
  back: "bg-white text-text-900 hover:text-secondary text-left flex items-center",
  trashButton: "bg-white text-text-900 text-md hover:text-red-500 transition-colors",
